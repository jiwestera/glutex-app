...
export const ActiveWorkoutModal: React.FC<ActiveWorkoutModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-stone-50 text-stone-900 flex flex-col overflow-hidden">
      ...
      {restTimerSeconds > 0 && (
        <div className="bg-stone-900 text-stone-100 px-6 py-2.5 flex items-center justify-between shadow-md text-xs font-medium border-b border-stone-800 animate-fadeIn">
          <div className="flex items-center space-x-2">
            <Clock className="w-4 h-4 text-stone-300 animate-spin" />
            <span className="tracking-wide">Rest Period: <strong className="font-mono text-stone-100">{formatTime(restTimerSeconds)}</strong> remaining</span>
          </div>
