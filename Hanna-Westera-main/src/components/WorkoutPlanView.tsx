            ...
            {currentDay.exercises.map((item, index) => {
              ...
              return (
                ...
                {/* Sets, Reps, RPE, Rest Grid */}
                  ...
                  {item.notes && (
                    <div className="text-xs text-stone-700 dark:text-stone-200 bg-[#faf8f5] dark:bg-stone-800/80 p-3 rounded-xl border border-[#eee4dc] dark:border-stone-700 font-sans leading-relaxed">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-stone-900 text-stone-100 rounded-3xl p-6 space-y-4 shadow-sm border border-stone-800">
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-[#f39c73] hover:bg-[#e4865a] active:bg-[#d47348] dark:bg-[#fce8dc] dark:hover:bg-[#f2d3c1] dark:active:bg-[#e5beaa] text-xs font-bold uppercase tracking-wider rounded-xl flex items-center justify-center space-x-2 transition-all cursor-pointer shadow-xs"
            >
              <span className="font-bold text-[#1c1917]">Consult AI Coach</span>
              <ChevronRight className="w-4 h-4 stroke-[2.5] text-[#1c1917]" />
            </button>
          </div>
        </div>
      </div>
