...
export const prebuiltSplits: WorkoutSplit[] = [
  ...
  // -------------------------------------------------------------
  {
    ...
    tagline: 'Maximum stimulus per workout with full recovery between sessions.',
  ...
  // -------------------------------------------------------------
  {
    ...
    tagline: 'The gold standard for glute development, frequency, and balanced recovery.',
  ...
  // -------------------------------------------------------------
  {
    ...
    tagline: 'High volume split with dedicated focus on glute max density & upper shelf side shape.',
  ...
  // -------------------------------------------------------------
  {
    id: 'split-5-days',
    daysPerWeek: 5,
    name: '5-Day Pro Glute Building Specialization',
    tagline: 'High-frequency specialization split for experienced gym-goers.',
  ...
  // -------------------------------------------------------------
  {
    id: 'split-6-days',
    daysPerWeek: 6,
    name: '6-Day Advanced Push/Pull/Glute Frequency Split',
    tagline: 'Elite level high-frequency split with strict per-session fatigue management.',
    description: 'For advanced bodybuilders and hypertrophy enthusiasts. Sessions are brief (30-35 mins) but frequent, maintaining maximal mechanical tension without joint strain.',
    weeklyVolumeNotes: '28-30 total glute sets per week distributed across 6 micro-sessions.',
    idealDaysSchedule: 'Mon - Sat (Sunday complete rest).',
    days: [
      {
        dayNumber: 1,
        title: 'Day 1: Heavy Thrust Focus',
        focus: 'Barbell Hip Thrust',
        estimatedMinutes: 35,
        warmupMobilityIds: ['pre-glute-activation'],
        exercises: [
          { exerciseId: 'barbell-hip-thrust', sets: 4, reps: '6-8', rpe: 'RPE 8-9', restSeconds: 150 },
          { exerciseId: 'cable-standing-hip-abduction', sets: 3, reps: '15 / leg', rpe: 'RPE 8', restSeconds: 60 }
        ]
      },
      {
        dayNumber: 2,
        title: 'Day 2: RDL Stretch Focus',
        focus: 'Dumbbell RDL + Hamstrings',
        estimatedMinutes: 35,
        warmupMobilityIds: ['deep-hip-flow'],
        exercises: [
          { exerciseId: 'dumbbell-rdl', sets: 4, reps: '8-10', rpe: 'RPE 8', restSeconds: 90 },
          { exerciseId: 'hyperextension-45-glute', sets: 3, reps: '12-15', rpe: 'RPE 8', restSeconds: 75 }
        ]
      },
      {
        dayNumber: 3,
        title: 'Day 3: Unilateral Single-Leg',
        focus: 'Bulgarian Split Squats',
        estimatedMinutes: 35,
        warmupMobilityIds: ['pre-glute-activation'],
        exercises: [
          { exerciseId: 'bulgarian-split-squat-glute', sets: 4, reps: '10 / leg', rpe: 'RPE 8-9', restSeconds: 120 },
          { exerciseId: 'seated-machine-hip-abduction', sets: 3, reps: '18', rpe: 'RPE 9', restSeconds: 60 }
        ]
      },
      {
        dayNumber: 4,
        title: 'Day 4: Upper Shelf Specialization',
        focus: 'Abduction & Cable Isolation',
        estimatedMinutes: 35,
        warmupMobilityIds: ['desk-worker-reset'],
        exercises: [
          { exerciseId: 'cable-standing-hip-abduction', sets: 4, reps: '15 / leg', rpe: 'RPE 9', restSeconds: 60 },
          { exerciseId: 'cable-glute-kickback', sets: 4, reps: '12 / leg', rpe: 'RPE 8', restSeconds: 60 }
        ]
      },
      {
        dayNumber: 5,
        title: 'Day 5: Kas Bridge Peak Contraction',
        focus: 'Kas Bridge + Deficit Lunge',
        estimatedMinutes: 35,
        warmupMobilityIds: ['pre-glute-activation'],
        exercises: [
          { exerciseId: 'kas-glute-bridge', sets: 4, reps: '10-12', rpe: 'RPE 8-9', restSeconds: 120 },
          { exerciseId: 'deficit-reverse-lunge', sets: 3, reps: '10 / leg', rpe: 'RPE 8', restSeconds: 90 }
        ]
      },
      {
        dayNumber: 6,
        title: 'Day 6: Glute Burnout & Mobility Finale',
        focus: 'Step-Ups + Frog Pumps',
        estimatedMinutes: 35,
        warmupMobilityIds: ['pre-glute-activation'],
        exercises: [
          { exerciseId: 'step-up-glute-bias', sets: 3, reps: '10 / leg', rpe: 'RPE 8', restSeconds: 90 },
          { exerciseId: 'frog-pump', sets: 3, reps: '30', rpe: 'RPE 10', restSeconds: 45 },
          { exerciseId: 'banded-side-clamshell', sets: 3, reps: '20 / side', rpe: 'RPE 9', restSeconds: 45 }
        ]
      }
    ]
  }
