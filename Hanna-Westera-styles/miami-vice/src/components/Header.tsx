    ...
    <header className="bg-white/95 backdrop-blur-md border-b border-stone-200/60 text-stone-900 sticky top-0 z-30 shadow-2xs transition-colors">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center space-x-2.5 sm:space-x-3 cursor-pointer shrink-0" onClick={() => onTabChange('workout')}>
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-stone-900 dark:bg-[#fce8dc] logo-dumbbell-circle flex items-center justify-center shadow-sm shrink-0">
              <Dumbbell className="w-4 h-4 sm:w-5 sm:h-5 text-white dark:text-[#1c1917] logo-dumbbell-icon transform -rotate-45" />
            </div>
            <div>
              <div className="flex items-center space-x-2 sm:space-x-2.5">
                <h1 className="text-xl sm:text-2xl md:text-3xl font-normal tracking-[0.14em] leading-none mv-gradient-text drop-shadow-[0_0_18px_rgba(255,46,147,0.45)]">
                  GLUTE<span className="font-bold">X</span>
                </h1>
                {extraDays > 0 ? (
                  <span
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-2.5 shrink-0">
            ...
            <button
              ...
              className="flex items-center space-x-1.5 px-2.5 py-1.5 sm:px-3 rounded-full bg-stone-900 text-white text-xs font-semibold hover:bg-stone-800 transition-all cursor-pointer shadow-xs shrink-0 mv-glow-cyan"
            ...
            return (
              <button
                ...
                className={`flex items-center space-x-2 px-4 py-1.5 text-xs font-semibold rounded-full transition-all whitespace-nowrap border cursor-pointer ${
                  isActive
                    ? 'border-stone-900 bg-stone-900 text-white shadow-xs mv-glow-pink'
      ...
      {isOptionsOpen && (
        <div className="fixed inset-0 bg-stone-950/60 backdrop-blur-xs z-50 flex items-center justify-center p-4">
          <div className="bg-white border border-stone-200 rounded-3xl p-6 sm:p-8 max-w-lg w-full shadow-2xl mv-glow-cyan space-y-6 animate-in fade-in zoom-in-95 duration-150 text-left max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
            <div className="flex items-center justify-between border-b border-stone-100 pb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-xl font-medium mv-gradient-text">App Options & Settings</h3>
      ...
      {isClearModalOpen && (
        <div className="fixed inset-0 bg-stone-950/60 backdrop-blur-xs z-50 flex items-center justify-center p-4">
          <div className="bg-white border border-stone-200 rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl mv-glow-pink space-y-6 animate-in fade-in zoom-in-95 duration-150 text-left">
            <div className="flex items-start space-x-4">
              ...
              <div className="space-y-1.5">
                <h3 className="text-xl font-medium mv-gradient-text">Clear Everything?</h3>
