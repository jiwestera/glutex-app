      ...
      <div className="bg-white border border-stone-200 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xs mv-glow-pink">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl font-normal mv-gradient-text tracking-tight mt-0.5">Exercise Library</h1>
            ...
            <div
              ...
              className={`bg-white border rounded-3xl p-6 space-y-4 transition-all shadow-xs flex flex-col justify-between relative ${
                isHidden
                  ...
                  : 'border-stone-200 hover:border-stone-300 hover:mv-glow-cyan'
              }`}
            >
              <div className="space-y-2">
                ...
                <h3 className="text-lg font-medium mv-gradient-text pt-1">{ex.name}</h3>
          ...
          <div className="bg-white border border-stone-200 rounded-3xl max-w-xl w-full p-6 sm:p-8 space-y-6 relative shadow-2xl mv-glow-pink text-stone-900">
            <div className="flex items-start justify-between border-b border-stone-100 pb-4">
              <div>
                ...
                <h3 className="text-2xl font-normal mv-gradient-text mt-0.5">{activeModalExercise.name}</h3>
              </div>
              <button
