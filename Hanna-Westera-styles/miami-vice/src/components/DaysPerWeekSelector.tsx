...
export const DaysPerWeekSelector: React.FC<DaysPerWeekSelectorProps> = ({
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto py-8 px-4">
      {/* Hero Banner */}
      <div className="bg-white border border-stone-200 rounded-3xl p-6 sm:p-8 shadow-xs mv-glow-pink space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="max-w-3xl space-y-3">
            ...
            <h1 className="text-3xl sm:text-4xl font-normal mv-gradient-text tracking-tight flex items-center gap-2">
          ...
          <button
            ...
            className="self-start sm:self-center px-5 py-3 bg-stone-900 hover:bg-stone-800 text-white font-semibold text-xs tracking-wider uppercase rounded-full shadow-md mv-glow-cyan transition-all shrink-0 flex items-center space-x-2 cursor-pointer"
          >
            ...
            return (
              <div
                ...
                className={`cursor-pointer rounded-2xl p-5 border transition-all duration-200 relative flex flex-col justify-between ${
                  isSelected
                    ? 'bg-stone-900 border-stone-900 text-white shadow-md mv-glow-pink'
        ...
        <div className="bg-white border border-stone-200 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xs mv-glow-cyan">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-stone-100">
            <div>
              ...
              <h2 className="text-2xl font-normal mv-gradient-text tracking-tight">{activeSplit.name}</h2>
              <p className="text-xs sm:text-sm text-stone-500 mt-1 max-w-2xl">{activeSplit.description}</p>
            </div>

            <button
              onClick={onContinueToWorkout}
              className="bg-stone-900 hover:bg-stone-800 text-white font-medium px-6 py-3.5 rounded-full shadow-xs mv-glow-pink flex items-center justify-center space-x-2 transition-all text-xs tracking-wider uppercase whitespace-nowrap shrink-0 cursor-pointer"
            >
