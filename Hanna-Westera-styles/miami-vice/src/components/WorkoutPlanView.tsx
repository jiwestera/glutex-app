...
export const WorkoutPlanView: React.FC<WorkoutPlanViewProps> = ({
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4 space-y-8">
      ...
      <div className="bg-white border border-stone-200 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xs mv-glow-pink">
          ...
          <div className="space-y-3 sm:space-y-3.5">
            ...
            <div className="flex items-center space-x-2 group pt-1">
              {isEditingTitle ? (
                ...
                <>
                  <h1 className="text-3xl sm:text-4xl font-normal tracking-tight mv-gradient-text">
                    {split.name}
                  </h1>
                  {onRenameSplit && (
                    <button
              ...
              <div key={day.dayNumber} className="relative group/tab flex">
                <button
                  ...
                  className={`w-full p-2.5 sm:p-3 rounded-2xl font-medium transition-all border text-left cursor-pointer flex flex-col justify-between ${
                    isSelected
                      ? 'border-stone-900 bg-stone-900 text-white shadow-xs mv-glow-cyan dark:bg-stone-100 dark:text-stone-950 dark:border-stone-100'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-3 sm:gap-4">
            <div className="w-full">
              ...
              <h2 className="text-xl sm:text-2xl font-normal mv-gradient-text tracking-tight mt-0.5 leading-snug">
                {currentDay.title}
              </h2>
            </div>
            <div className="flex items-center space-x-2 shrink-0 flex-wrap gap-2 pt-1 sm:pt-0">
              ...
              <span className="text-xs text-stone-500 font-medium flex items-center space-x-1.5 bg-stone-100 px-3 py-1 rounded-full border border-stone-200/80">
                ...
                <span>Est. {currentDay.estimatedMinutes} mins</span>
              </span>
          ...
          <div className="space-y-4">
            {currentDay.exercises.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white border border-stone-200 hover:border-stone-300 hover:mv-glow-cyan rounded-2xl p-4 sm:p-6 transition-all shadow-xs space-y-4"
                >
                    ...
                    <div className="flex items-start justify-between gap-2 sm:gap-4">
                      <div className="flex items-start space-x-2.5 sm:space-x-3 min-w-0">
                        ...
                        <div className="flex flex-col items-center shrink-0 mt-0.5">
                          <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-stone-100 border border-stone-200 text-stone-800 flex items-center justify-center font-bold text-xs">
                            ...
                            <div className="flex flex-wrap items-center gap-1.5">
                              ...
                              {lastLogged && (lastLogged.weightKg > 0 || lastLogged.reps > 0) && (
                                ...
                                >
                                  ...
                                  <span>Last: {lastLogged.weightKg} {unit} × {lastLogged.reps} reps</span>
                                </span>
                              )}
                            </div>
                          </div>
                      ...
                      <div className="flex items-center space-x-1 shrink-0">
                        ...
                        {onRemoveExercise && currentDay.exercises.length > 1 && (
                          <button
                            onClick={() => onRemoveExercise(currentDay.dayNumber, index)}
                ...
                {/* Sets, Reps, RPE, Rest Grid */}
                  <div className="grid grid-cols-4 gap-1.5 sm:gap-2 bg-stone-50 p-3 rounded-xl border border-stone-200/80 text-xs">
                    <div className="flex flex-col justify-between items-center text-center min-w-0">
                      ...
                      <div className="flex items-center justify-center h-7 mt-0.5">
                        <span className="font-serif font-bold mv-gradient-text text-sm sm:text-lg leading-none">{item.sets}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col justify-between items-center text-center min-w-0">
                      ...
                      <div className="flex items-center justify-center h-7 mt-0.5">
                        <span className="font-serif font-bold mv-gradient-text text-sm sm:text-lg leading-none">{item.reps}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col justify-between items-center text-center min-w-0">
                      ...
                      <div className="flex items-center justify-center h-7 mt-0.5">
                        <span className="font-serif font-bold mv-gradient-text text-sm sm:text-lg leading-none">{item.rpe}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col justify-between items-center text-center min-w-0">
                      ...
                      <div className="flex items-center justify-center h-7 mt-0.5">
                        {onUpdateExercise ? (
                          ...
                          >
                            <span className={`font-semibold text-xs sm:text-base leading-none ${item.restSeconds === 0 ? 'text-rose-700' : 'text-stone-900'}`}>
                  ...
                  {item.notes && (
                    <div className="text-xs text-stone-700 dark:text-stone-200 bg-stone-50 dark:bg-stone-800/80 p-3 rounded-xl border border-stone-200 dark:border-stone-700 font-sans leading-relaxed">
        ...
        <div className="space-y-6">
                  ...
                  <div key={routine.id} className="bg-white p-5 rounded-2xl border border-stone-200 shadow-2xs space-y-3 relative group/warmup">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <div className="flex items-center space-x-1.5 shrink-0">
                        ...
                        {onRemoveWarmupFromDay && (
                          <button
                            onClick={() => onRemoveWarmupFromDay(currentDay.dayNumber, routine.id)}
          ...
          <div className="bg-stone-900 text-stone-100 rounded-3xl p-6 space-y-4 shadow-sm border border-stone-800 mv-glow-cyan">
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-[#01fff4] hover:bg-[#6df3ff] active:bg-[#00d9d0] text-xs font-bold uppercase tracking-wider rounded-xl flex items-center justify-center space-x-2 transition-all cursor-pointer shadow-xs mv-glow-cyan"
            >
              <span className="font-bold text-[#0d0221]">Consult AI Coach</span>
              <ChevronRight className="w-4 h-4 stroke-[2.5] text-[#0d0221]" />
            </button>
          </div>
        </div>
      </div>
      ...
      {selectedExerciseForDetail && (
        <div className="fixed inset-0 z-50 bg-stone-950/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white border border-stone-200 rounded-3xl max-w-xl w-full p-6 sm:p-8 space-y-6 relative shadow-2xl mv-glow-pink text-stone-900">
            <div className="flex items-start justify-between border-b border-stone-100 pb-4">
              <div>
                <span className="text-[10px] font-bold text-stone-500 uppercase tracking-widest">
                  {selectedExerciseForDetail.biomechanicsType} • {selectedExerciseForDetail.targetRegion}
                </span>
                <h3 className="text-2xl font-normal mv-gradient-text mt-0.5">
