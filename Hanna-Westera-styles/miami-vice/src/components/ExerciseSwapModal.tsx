...
export const ExerciseSwapModal: React.FC<ExerciseSwapModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-stone-950/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
      <div className="bg-white border border-stone-200 rounded-3xl overflow-hidden max-w-4xl sm:max-w-5xl w-full relative shadow-2xl mv-glow-pink text-stone-900 my-auto max-h-[92vh] h-[88vh] flex flex-col">
        {/* Modal Header */}
