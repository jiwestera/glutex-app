...
export const AddWarmupModal: React.FC<AddWarmupModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-stone-950/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
      <div className="bg-white border border-stone-200 rounded-3xl overflow-hidden max-w-3xl sm:max-w-4xl w-full relative shadow-2xl mv-glow-cyan text-stone-900 my-auto max-h-[92vh] h-[88vh] flex flex-col">
        {/* Header */}
        <div className="flex items-start justify-between border-b border-stone-100 p-6 sm:p-8 pb-4 bg-white shrink-0">
          <div>
            ...
            <h3 className="text-2xl sm:text-3xl font-normal mv-gradient-text">
              Add Warm-Up Routine
            </h3>
          </div>
          <button
