...
export const CreateCustomSplitModal: React.FC<CreateCustomSplitModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-stone-950/70 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 overflow-y-auto animate-fadeIn">
      <div className="bg-white border border-stone-200 rounded-3xl overflow-hidden max-w-3xl w-full relative shadow-2xl mv-glow-cyan text-stone-900 my-auto max-h-[92vh] flex flex-col">
        {/* Header */}
        <div className="flex items-start justify-between border-b border-stone-100 p-6 sm:p-8 pb-4 bg-white shrink-0">
          <div className="space-y-1">
            ...
            <h2 className="text-2xl font-normal mv-gradient-text tracking-tight">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  value={daysPerWeek}
                  onChange={(e) => handleDaysPerWeekChange(parseInt(e.target.value))}
              ...
              {days.map((day, idx) => (
                ...
                >
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-xs font-bold uppercase tracking-widest text-stone-900 bg-stone-200/80 px-2.5 py-0.5 rounded-md">
                      Session 0{idx + 1}
                    </span>
                    ...
                    <div className="flex items-center space-x-2">
                      <select
                        onChange={(e) => {
                          if (e.target.value) handleApplyPresetToDay(idx, e.target.value);
                        }}
                        defaultValue=""
