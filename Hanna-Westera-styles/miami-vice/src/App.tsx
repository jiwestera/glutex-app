...
export default function App() {
  ...
  return (
    <div className="min-h-screen text-stone-900 dark:text-stone-100 flex flex-col font-sans selection:bg-stone-900 selection:text-white transition-colors duration-200">
      {/* Header Bar */}
      <Header
      ...
      <footer className="border-t border-stone-200/80 bg-stone-100/50 py-6 px-4 text-center">
        <p className="text-xs text-stone-500 font-medium tracking-wide uppercase">
          © 2026 Hanna Westera™ <span className="mv-gradient-text font-semibold">· All Rights Reserved ·</span>
        </p>
      </footer>
