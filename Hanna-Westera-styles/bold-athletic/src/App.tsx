...
export default function App() {
  ...
  return (
    <div className="min-h-screen app-shell-bg text-stone-900 dark:text-stone-100 flex flex-col font-sans selection:bg-[#d4ff3f] selection:text-black transition-colors duration-200">
      {/* Header Bar */}
      <Header
      ...
      <footer className="border-t-2 border-stone-200/80 bg-stone-100/50 py-6 px-4 text-center">
