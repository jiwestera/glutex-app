      ...
      <div className="bg-white border border-stone-200 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          ...
          <button
            ...
            className="bg-[#d4ff3f] hover:bg-black text-black hover:text-[#d4ff3f] border-2 border-black font-black px-8 py-3.5 shadow-sm flex items-center justify-center space-x-2 transition-all text-xs tracking-wider uppercase cursor-pointer group"
          >
            <Play className="w-4 h-4 fill-current text-black group-hover:text-[#d4ff3f]" />
            ...
            {currentDay.exercises.map((item, index) => {
              ...
              return (
                ...
                {/* Sets, Reps, RPE, Rest Grid */}
                  <div className="grid grid-cols-4 gap-1.5 sm:gap-2 bg-stone-50 p-3 rounded-xl border border-stone-200/80 text-xs">
                    <div className="flex flex-col justify-between items-center text-center min-w-0">
                      ...
                      <div className="flex items-center justify-center h-7 mt-0.5">
                        <span className="font-semibold text-stone-900 text-xs sm:text-base leading-none">{item.sets}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col justify-between items-center text-center min-w-0">
                      ...
                      <div className="flex items-center justify-center h-7 mt-0.5">
                        <span className="font-semibold text-stone-900 text-xs sm:text-base leading-none">{item.reps}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col justify-between items-center text-center min-w-0">
                      ...
                      <div className="flex items-center justify-center h-7 mt-0.5">
                        <span className="font-semibold text-stone-900 text-xs sm:text-base leading-none">{item.rpe}</span>
                      </div>
                    </div>
                  ...
                  {item.notes && (
                    <div className="text-xs text-stone-700 dark:text-stone-200 bg-stone-100 dark:bg-stone-800/80 p-3 border-2 border-black dark:border-stone-700 font-sans leading-relaxed">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-stone-900 text-stone-100 rounded-3xl p-6 space-y-4 shadow-sm border border-stone-800">
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-[#d4ff3f] hover:bg-black active:bg-black border-2 border-black text-xs font-bold uppercase tracking-wider flex items-center justify-center space-x-2 transition-all cursor-pointer shadow-xs group"
            >
              <span className="font-bold text-black group-hover:text-[#d4ff3f]">Consult AI Coach</span>
              <ChevronRight className="w-4 h-4 stroke-[2.5] text-black group-hover:text-[#d4ff3f]" />
            </button>
          </div>
        </div>
      </div>
