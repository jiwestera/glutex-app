    ...
    <div className="max-w-6xl mx-auto py-8 px-4 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="bg-white border border-stone-200 rounded-3xl p-6 space-y-2 shadow-xs">
          ...
          <p className="text-4xl font-light text-stone-950 tracking-tight">{logs.length}</p>
        ...
        <div className="bg-white border border-stone-200 rounded-3xl p-6 space-y-2 shadow-xs">
          ...
          <p className="text-4xl font-light text-stone-950 tracking-tight">{prList.length}</p>
        ...
        <div className="bg-white border border-stone-200 rounded-3xl p-6 space-y-2 shadow-xs">
          ...
          <p className="text-4xl font-light text-stone-950 tracking-tight">{logs.length > 0 ? 'Active' : '0'}</p>
