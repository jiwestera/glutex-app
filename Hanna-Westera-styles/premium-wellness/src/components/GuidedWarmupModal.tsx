  ...
  return (
    ...
    >
      <div
        ...
        className="bg-stone-900 text-stone-100 border border-stone-800 rounded-3xl max-w-2xl w-full max-h-[92vh] overflow-y-auto p-5 sm:p-8 space-y-6 relative shadow-2xl my-auto"
      >
        ...
        <div className="sticky -top-5 sm:-top-8 -mx-5 sm:-mx-8 px-5 sm:px-8 pt-5 sm:pt-8 pb-4 bg-stone-900/95 backdrop-blur-sm z-20 flex items-center justify-between border-b border-stone-800">
          <div>
            ...
            <h2 className="text-lg sm:text-2xl font-light text-stone-100 mt-0.5">{routine.name}</h2>
          </div>
        ...
        {isCompleted ? (
          <div className="py-8 text-center space-y-6 animate-fadeIn">
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-light text-stone-100">Routine Completed!</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-stone-950/90 p-6 rounded-2xl border border-stone-800 flex flex-col items-center justify-between text-center space-y-5">
              ...
              <div className="relative w-36 h-36 rounded-full border-2 border-stone-700 flex flex-col items-center justify-center bg-stone-900 shadow-inner">
                <span className="text-4xl font-serif font-light text-stone-100">
                  {stepTimerSeconds}s
                </span>
