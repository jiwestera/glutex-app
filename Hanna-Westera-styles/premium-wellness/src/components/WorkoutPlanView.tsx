      ...
      <div className="bg-white border border-stone-200 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div className="space-y-3 sm:space-y-3.5">
              ...
              {isEditingTitle ? (
                <div className="flex items-center space-x-2 my-1">
                  <input
                    ...
                    className="text-2xl sm:text-3xl font-serif font-light border-b-2 border-stone-900 bg-transparent text-stone-950 focus:outline-none px-1"
            ...
            <p className="text-xs sm:text-sm text-stone-500 mt-1 max-w-2xl font-serif italic">
              {split.tagline}
            </p>
          </div>
            ...
            {currentDay.exercises.map((item, index) => {
              ...
              return (
                ...
                {/* Sets, Reps, RPE, Rest Grid */}
                  ...
                  {item.notes && (
                    <div className="text-xs text-stone-700 dark:text-stone-200 bg-[#faf6ee] dark:bg-stone-800/80 p-3 rounded-xl border border-[#ece2d0] dark:border-stone-700 font-sans leading-relaxed">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-stone-900 text-stone-100 rounded-3xl p-6 space-y-4 shadow-sm border border-stone-800">
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-[#b98a3c] hover:bg-[#a37530] active:bg-[#85601f] dark:bg-[#cba86c] dark:hover:bg-[#dbb96c] dark:active:bg-[#e8cf94] text-xs font-bold uppercase tracking-wider rounded-xl flex items-center justify-center space-x-2 transition-all cursor-pointer shadow-xs"
            >
              <span className="font-bold text-[#221d19]">Consult AI Coach</span>
              <ChevronRight className="w-4 h-4 stroke-[2.5] text-[#221d19]" />
            </button>
          </div>
        </div>
      </div>
