      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center space-x-2.5 sm:space-x-3 cursor-pointer shrink-0" onClick={() => onTabChange('workout')}>
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-stone-900 dark:bg-[#cba86c] logo-dumbbell-circle flex items-center justify-center shadow-sm shrink-0">
              <Dumbbell className="w-4 h-4 sm:w-5 sm:h-5 text-white dark:text-[#221d19] logo-dumbbell-icon transform -rotate-45" />
            </div>
            <div>
              <div className="flex items-center space-x-2 sm:space-x-2.5">
                <h1 className="text-xl sm:text-2xl md:text-3xl font-serif font-medium tracking-tight text-stone-800 dark:text-stone-100 leading-none">
                  GLUTE<span className="font-bold text-rose-600 dark:text-rose-400">X</span>
                </h1>
                {extraDays > 0 ? (
                  <span
              ...
              <p className="text-[10px] sm:text-[11px] text-stone-500 font-serif italic tracking-wide hidden md:block mt-0.5">
