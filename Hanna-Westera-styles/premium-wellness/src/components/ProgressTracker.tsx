  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="bg-white border border-stone-200 rounded-3xl p-6 space-y-2 shadow-xs">
          <div className="flex items-center justify-between text-xs font-bold text-stone-400 uppercase tracking-widest">
            <span>Workouts Completed</span>
            <Calendar className="w-4 h-4 text-stone-700" />
          </div>
          <p className="text-4xl font-serif font-light text-stone-950 tracking-tight">{logs.length}</p>
        ...
        <div className="bg-white border border-stone-200 rounded-3xl p-6 space-y-2 shadow-xs">
          ...
          <p className="text-4xl font-serif font-light text-stone-950 tracking-tight">{prList.length}</p>
        ...
        <div className="bg-white border border-stone-200 rounded-3xl p-6 space-y-2 shadow-xs">
          ...
          <p className="text-4xl font-serif font-light text-stone-950 tracking-tight">{logs.length > 0 ? 'Active' : '0'}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {prList.map((pr, idx) => (
              <div key={idx} className="bg-stone-50 p-5 rounded-2xl border border-stone-200/80 space-y-1">
                ...
                <div className="text-xl font-serif font-light text-amber-600">
                  {pr.maxWeight} {unit} <span className="text-xs text-stone-500 font-sans font-normal">x {pr.maxReps} reps</span>
                </div>
