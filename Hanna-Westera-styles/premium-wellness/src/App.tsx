...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#faf7f2] dark:bg-[#211d19] text-stone-900 dark:text-stone-100 flex flex-col font-sans selection:bg-rose-500 selection:text-white transition-colors duration-200">
      {/* Header Bar */}
      <Header
