  ...
  return (
    ...
    >
      <div
        ...
        className="bg-stone-900 text-stone-100 border border-stone-800 rounded-3xl max-w-2xl w-full max-h-[92vh] overflow-y-auto p-5 sm:p-8 space-y-6 relative shadow-2xl my-auto hud-corners"
      >
        ...
        {isCompleted ? (
          <div className="py-8 text-center space-y-6 animate-fadeIn">
            <div className="w-20 h-20 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 flex items-center justify-center mx-auto glow-border-lime">
