...
export const ExerciseSwapModal: React.FC<ExerciseSwapModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-stone-950/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
      <div className="bg-white border border-stone-200 rounded-3xl overflow-hidden max-w-4xl sm:max-w-5xl w-full relative shadow-2xl text-stone-900 my-auto max-h-[92vh] h-[88vh] flex flex-col hud-corners">
        {/* Modal Header */}
        <div className="flex flex-wrap items-start justify-between gap-3 border-b border-stone-100 p-6 sm:p-8 pb-4 bg-white shrink-0">
          <div className="space-y-1 min-w-0 basis-full sm:basis-auto sm:flex-1">
          ...
          <div className="flex items-center space-x-2 shrink-0">
            <button
              ...
              className="flex items-center space-x-1.5 px-3.5 py-2 rounded-full bg-stone-900 hover:bg-stone-800 text-white font-medium text-xs shadow-2xs transition-all cursor-pointer shrink-0"
              title="Create a new custom exercise"
            >
              <Sparkles className="w-3.5 h-3.5 text-rose-300 shrink-0" />
              <span className="whitespace-nowrap">Create Custom +</span>
            </button>
        ...
        <div className="flex-1 overflow-y-auto p-6 sm:p-8 py-5 space-y-5 bg-white">
          ...
          <div className="space-y-3.5 bg-stone-50/80 p-4 sm:p-5 rounded-2xl border border-stone-200/80">
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-1 bg-white p-1 rounded-2xl sm:rounded-full border border-stone-200 text-xs font-medium shadow-2xs">
                <button
                  onClick={() => setRegionScopeFilter('same-region')}
                  className={`w-full sm:w-auto px-3 py-1.5 sm:py-1 rounded-xl sm:rounded-full transition-all text-[11px] text-left sm:text-center cursor-pointer ${
