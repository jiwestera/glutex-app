            ...
            {currentDay.exercises.map((item, index) => {
              ...
              return (
                ...
                {/* Sets, Reps, RPE, Rest Grid */}
                  ...
                  {item.notes && (
                    <div className="text-xs text-stone-700 dark:text-stone-200 bg-[#fbeed9] dark:bg-stone-800/80 p-3 rounded-xl border border-[#e8c88a] dark:border-stone-700 font-sans leading-relaxed">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-stone-900 text-stone-100 rounded-3xl p-6 space-y-4 shadow-sm border border-stone-800">
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-[#2a7f7a] hover:bg-[#246e6a] active:bg-[#1f605c] dark:bg-[#3aa39d] dark:hover:bg-[#2a7f7a] dark:active:bg-[#246e6a] text-xs font-bold uppercase tracking-wider rounded-xl flex items-center justify-center space-x-2 transition-all cursor-pointer shadow-xs border-2 border-[#124542]"
            >
              <span className="font-bold text-[#fdf6e8]">Consult AI Coach</span>
              <ChevronRight className="w-4 h-4 stroke-[2.5] text-[#fdf6e8]" />
            </button>
          </div>
        </div>
      </div>
