      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center space-x-2.5 sm:space-x-3 cursor-pointer shrink-0" onClick={() => onTabChange('workout')}>
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-stone-900 dark:bg-[#fce8dc] logo-dumbbell-circle flex items-center justify-center shadow-sm shrink-0 -rotate-6">
              <Dumbbell className="w-4 h-4 sm:w-5 sm:h-5 text-white dark:text-[#1c1917] logo-dumbbell-icon transform -rotate-45" />
            </div>
            <div>
              <div className="flex items-center space-x-2 sm:space-x-2.5">
                <h1 className="text-2xl sm:text-3xl md:text-4xl tracking-tight text-stone-800 dark:text-stone-100 leading-none" style={{ fontFamily: "'Fredoka', 'Baloo 2', sans-serif", fontWeight: 700 }}>
                  GLUTE<span className="font-bold text-stone-950 dark:text-white">X</span>
                </h1>
                {extraDays > 0 ? (
                  <span
