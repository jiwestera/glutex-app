...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f5ead9] dark:bg-[#2a1610] text-stone-900 dark:text-stone-100 flex flex-col font-sans selection:bg-stone-900 selection:text-white transition-colors duration-200">
      {/* Header Bar */}
      <Header
